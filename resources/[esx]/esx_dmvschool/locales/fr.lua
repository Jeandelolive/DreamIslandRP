Locales['fr'] = {
  ...
  ['in_town_speed'] = 'entrée en ville, ralentissez ! Vitesse limite: ~y~%s~s~ km/h',
  ['next_point_speed'] = 'allez vers le prochain passage! Vitesse limite: ~y~%s~s~ km/h',
  ['stop_for_ped'] = 'faite un ~r~stop~s~ pour le piéton qui ~y~traverse',
  ['good_lets_cont'] = '~g~Bien!~s~ continuons!',
  ['stop_look_left'] = 'marquer un ~r~stop~s~ et regardez à votre ~y~gauche~s~. Vitesse limite: ~y~%s~s~ km/h',
  ...
  ['gratz_stay_alert'] = 'Felicitation , restez concentrer !',
  ['passed_test'] = 'vous avez ~g~réussi~s~ le test',
  ['failed_test'] = 'vous avez ~r~raté~s~ le test',
  ['theory_test'] = 'examen du code',
  ['road_test_car'] = 'examen permis voiture',
  ['road_test_bike'] = 'examen permis moto',
  ['road_test_truck'] = 'examen permis camion',
  ['school_item'] = '$%s',
